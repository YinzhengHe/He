...
<button ?disabled="${!this.enableStartCapture}" ?hidden="${this.toolbarHidden}" @click="${e => this._startCapturing(e)}">Start screen capture</button>
<button ?disabled="${!this.enableStopCapture}" ?hidden="${this.toolbarHidden}" @click="${e => this._stopCapturing(e)}">Stop screen capture</button>
<button ?disabled="${!this.enableDownloadRecording}" ?hidden="${this.toolbarHidden}" @click="${e => this._downloadRecording(e)}">Download recording</button>
    ...
    if (this.stream) {
      ...
      this.mediaRecorder.addEventListener('error', event => {
        ...
        switch (error.name) {
          ...
          case SecurityError:
            alert("Recording the specified source " + "is not allowed due to security " + "restrictions.");
            break;
